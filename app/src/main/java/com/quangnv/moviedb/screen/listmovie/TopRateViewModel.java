...
public class TopRateViewModel extends ListMovieViewModel {
    public TopRateViewModel(Context context, MovieRepository repository, MovieAdapter adapter) {
        super(context, repository, adapter);
    }

    @Override
    public String getTitleToolbar() {
        return mContext.getString(R.string.title_top_rate);
    }

    @Override
    protected void callApiGetListMovies(int page) {
        Disposable disposable = mRepository.getTopRated(page)
