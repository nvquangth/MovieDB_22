...
public class NowPlayingViewModel extends ListMovieViewModel {
    public NowPlayingViewModel(Context context, MovieRepository repository, MovieAdapter adapter) {
        super(context, repository, adapter);
    }

    @Override
    public String getTitleToolbar() {
        return mContext.getString(R.string.title_now_playing);
    }

    @Override
    protected void callApiGetListMovies(int page) {
        Disposable disposable = mRepository.getNowPlaying(page)
